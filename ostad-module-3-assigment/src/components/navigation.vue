<template>
    <nav class="site-nav dark js-site-navbar mb-5 site-navbar-target scrolled awake">
<div class="container bggreen">
<div class="site-navigation">
<a href="index.html" class="logo m-0 float-left">Launch<span class="text-primary">.</span></a>
...
<li><a href="#contact-section" class="nav-link active">Contact</a></li>
</ul>
