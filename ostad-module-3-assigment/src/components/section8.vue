...
<img src="https://preview.colorlib.com/theme/launch/images/about.svg" alt="Image" class="img-fluid">
</div> 
<div class="col-lg-4">
<div class="mb-4 aos-init" data-aos="fade-up" data-aos-delay="0">
<span class="caption">About</span>
<h2 class="heading">About Us</h2>
</div>
<div class="mb-4 aos-init" data-aos="fade-up" data-aos-delay="100">
...
<ul class="list-unstyled ul-check primary mb-4 aos-init" data-aos="fade-up" data-aos-delay="200">
<li>There live the blind texts</li>
<li>Far far away behind the word</li>
<li>Their place and supplies</li>
</ul>
<div class="row count-numbers">
<div class="col-lg-6 aos-init" data-aos="fade-up" data-aos-delay="0">
